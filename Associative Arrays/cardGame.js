...
Powers 2 to 10 have the same value and J to A are 11 to 14. Types are mapped to multipliers 
...
function cardGame(input) {
    ...
    function calculateSum(power, type) {
        let cardPowerMulti = cardPowers[power];
        let cardTypeMulti = cardTypes[type];
        return cardPowerMulti * cardTypeMulti;
    }
}
